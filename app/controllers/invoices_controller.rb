class InvoicesController < ApplicationController
  ...
  def create
    ...
    if @invoice.save
      redirect_to admin_seminar_path(@invoice.seminar, anchor: 'invoices'), notice: t(:created, model: Invoice.model_name.human)
    else
      render :new
    end
  end
  ...
  def update
    if @invoice.update invoice_params
      redirect_to admin_seminar_path(@invoice.seminar, anchor: 'invoices'), notice: t(:updated, model: Invoice.model_name.human)
    else
      render :show
    end
  end
